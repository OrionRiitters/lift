...
class ManageDB():
    """
    This class is used to query and modify the lift database
    using sqlite3.

    TODO Fix issue with decorator, line 43, AttributeError: __enter__
    """
    ...
    def open_close_connection(func):
        ...
        def decorated_function(*args):
            try:
                db = sqlite3.connect(ManageDB.DATABASE)
    ...
    def create_workouts_table(self, db, cur):
        """
    ...
    @open_close_connection
    def create_lifts_table(self, db, cur):
        """
        Creates lifts table.
        """
        with db:
    ...
    @open_close_connection
    def create_days_table(self, db, cur):
        """
        Creates days table.
        """
        with db:
    ...
    @open_close_connection
    def create_lifts_days_association_table(self, db, cur):
        """
    ...
    @open_close_connection
    def add_workout(self, db, cur, values):
        """
    ...
    @open_close_connection
    def add_day(self, db, cur, values):
        """
    ...
    @open_close_connection
    def add_lift(self, db, cur, values):
        """
    ...
    @open_close_connection
    def add_lifts_days_association(self, db, cur, values):
        """
    ...
    @open_close_connection
    def query_workouts(self, db, cur, values):
        """
    ...
    @open_close_connection
    def query_lifts(self, db, cur, values):
        """
    ...
    @open_close_connection
    def query_days(self, db, cur, values):
        """
